...
import kr.jeet.edu.bus.adapter.PhotoViewPagerAdapter;
import kr.jeet.edu.bus.common.IntentParams;
import kr.jeet.edu.bus.model.data.FileData;
import kr.jeet.edu.bus.receiver.DownloadReceiver;
...
import kr.jeet.edu.bus.view.CustomViewPager;
...
//            }else
                if(intent.hasExtra(IntentParams.PARAM_WEB_DETAIL_IMG) &&
